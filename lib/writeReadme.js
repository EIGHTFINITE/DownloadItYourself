...
const writeReadme = (downloadlist) => {
	const generateReadme = (t) => {
		...
		if(t === 'md') {
			...
			html += '| [<img src="https://nodejs.org/static/logos/nodejsHex.svg" width="31">](https://nodejs.org/)'
			...
			html += ' | &#x2714;&#xFE0F;'
			html += ' | Node is a free, open-source, cross-platform JavaScript runtime environment that lets developers create servers, web apps, command line tools and scripts.'
			html += ' | ' + nodeVersion + ' |\n\n'
		}
		else {
			html += '<h2>Binaries</h2>\n'
			...
			html += '<td><a href="https://www.7-zip.org/">uBlock Origin</a></td>\n'
			...
			html += '</tr>\n'
			html += '<tr>\n'
			html += '<td align="center"><a href="https://nodejs.org/"><img src="https://nodejs.org/static/logos/nodejsHex.svg" width="31"></a></td>\n'
			html += '<td><a href="https://nodejs.org/">Node</a></td>\n'
			...
			html += '<td align="center">&#x2714;&#xFE0F;</td>\n'
			html += '<td>Node is a free, open-source, cross-platform JavaScript runtime environment that lets developers create servers, web apps, command line tools and scripts.</td>\n'
