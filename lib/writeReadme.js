...
const writeReadme = (downloadlist) => {
	const generateReadme = (t) => {
		const traverseDependencies = (d, p, c) => {
			...
			for (const key of Object.keys(d)) {
				...
				if(d[key].type === 'github') {
					...
					d[key].icon = 'https://raw.githubusercontent.com/npm/logos/master/npm%20square/n.svg'
				}
				else {
					d[key].icon = 'https://raw.githubusercontent.com/npm/logos/master/npm%20logo/classic/npm-2009.svg'
				}
		...
		if(t === 'md') {
			...
			html += '| Icon | Name | Author | License | Source&nbsp;Code | Distribution | Description | Version |\n'
			html += '| :---: | --- | --- | --- | --- | :---: | --- | :---: |\n'
			html += '| [![](https://raw.githubusercontent.com/gorhill/uBlock/master/src/img/ublock.svg)](https://github.com/gorhill/uBlock)'
