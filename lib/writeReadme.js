...
const writeReadme = (downloadlist) => {
	const generateReadme = (t) => {
		...
		const portableGitVersion = readableVersion(require('../downloadlist.json').config['portable-git-short'])
		...
		if(t === 'md') {
			...
			html += ' | [PortableGit](https://gitforwindows.org/)'
			html += ' | Linus Torvalds'
			html += ' | [GPL-2.0](docs/legal/GPL-2.0.txt)'
			...
			html += '<td><a href="https://gitforwindows.org/">PortableGit</a></td>\n'
			html += '<td>Linus Torvalds</td>\n'
			html += '<td><a href="docs/legal/GPL-2.0.txt">GPL-2.0</a></td>\n'
