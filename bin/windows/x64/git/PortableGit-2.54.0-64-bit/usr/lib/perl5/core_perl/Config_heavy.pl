...
cf_by='runneradmin'
cf_email=''
cf_time='Thu Apr  2 19:54:57 UTC 2026'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
cpprun='gcc  -E'
cppstdin='gcc  -E'
cppsymbols='__amd64__=1 __amd64=1 __BYTE_ORDER__=1234 __CYGWIN__=1 __GNUC__=15 __GNUC_MINOR__=2 __LP64__=1 __MSYS__=1 __pic__=1 __PIC__=1 __STDC__=1 __unix__=1 __unix=1 __x86_64__=1 __x86_64=1 _GNU_SOURCE=1 _LONG_DOUBLE=long\ double _LP64=1 _POSIX_C_SOURCE=202405L _POSIX_SOURCE=1 _XOPEN_SOURCE_EXTENDED=1 _XOPEN_SOURCE=700 unix=1'
...
incpath=''
incpth='/usr/lib/gcc/x86_64-pc-cygwin/15.2.0/include /usr/include'
inews=''
...
mydomain='.gnhpge5vftzudnp2qhfvddkv4a.dx.internal.cloudapp.net'
myhostname='runnervm1t8t9'
myuname='cygwin_nt-10.0-20348 runnervm1t8t9 3.6.7-f2802c5f.x86_64 2026-03-15 08:40 utc x86_64 cygwin '
n='-n'
need_va_copy='undef'
netdb_hlen_type='int'
