...
// src/browser/api/browser-action.ts
var debug2 = __require("debug")("electron-chrome-extensions:browserAction");
if (!app.isReady()) {
...
var debug3 = __require("debug")("electron-chrome-extensions:windows");
...
// src/browser/api/tabs.ts
var debug4 = __require("debug")("electron-chrome-extensions:tabs");
...
var _TabsAPI = class _TabsAPI {
  ...
  onRemoved(tabId) {
    ...
    const win = typeof windowId !== "undefined" && windowId > -1 ? BrowserWindow2.getAllWindows().find((win2) => win2.id === windowId) : null;
...
var debug5 = __require("debug")("electron-chrome-extensions:webNavigation");
...
var debug6 = __require("debug")("electron-chrome-extensions:store");
...
// src/browser/api/lib/native-messaging-host.ts
var d = __require("debug")("electron-chrome-extensions:nativeMessaging");
