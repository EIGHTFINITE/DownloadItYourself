...
const resolveExtensionPath = (extension, uri) => {
  const resPath = path__WEBPACK_IMPORTED_MODULE_1__.join(extension.path, uri);
  ...
  buildMenuItemsForParams(webContents, params) {
    ...
    for (const [extensionId, propItems] of this.menus) {
      ...
      if (topLevelItems.length > 1) {
        ...
        const children = extensionMenuItemOptions.map(opt => opt.props.parentId ? opt : {
          ...opt,
          props: {
            ...opt.props,
            parentId: groupId
...
const VALID_LICENSES = ['GPL-3.0', 'Patron-License-2020-11-19'];
const getLicenseNotice = () => `Please select a distribution license compatible with your application.
...
class ElectronChromeExtensions extends events__WEBPACK_IMPORTED_MODULE_1__.EventEmitter {
  ...
  constructor(opts) {
    ...
    if (!VALID_LICENSES.includes(license) && license !== INTERNAL_LICENSE) {
      throw new Error(`ElectronChromeExtensions: Invalid 'license' property: ${license}\n${getLicenseNotice()}`);
    }
...
class PopupView {
  ...
  setSize(rect) {
    ...
    (_this$browserWindow4 = this.browserWindow) === null || _this$browserWindow4 === void 0 ? void 0 : _this$browserWindow4.setBounds({
...
const createDebug = __webpack_require__(/*! debug */ "../../node_modules/debug/src/index.js");
