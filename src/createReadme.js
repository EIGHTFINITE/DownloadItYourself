...
module.exports = function(filetype) {
	...
	for (var i = 0; i < 3; i++) {
		...
		for (var k = 0; k < global.downloads.length; k++) {
			...
			if((i === 0 && (current.type.includes("executable") || current.type === 'binary' )) || (i === 1 && current.type !== 'library' && !(current.type.includes("executable") || current.type === 'binary' )) || (i === 2 && current.type === 'library')) {
				...
				// License
				readme += '\r\n<td>' + (current.license ? '<a href="docs/legal/' + current.license.txt + '.txt" title="“' + current.name + '” ' + licenseDedicationTitle(current.license.txt) + '">' + current.license.txt + '</a>' + (current.license.source ? '<a href="' + current.license.source + '" title="“' + current.name + '” license information"><img src="docs/img/vector/source.svg" height="24" alt="(source)" title="“' + current.name + '” license information"></a>' : '') : '');

				// EULA
				readme += '\r\n' + (current.eula ? ', <a href="docs/legal/' + current.eula.txt + '.txt" title="“' + current.name + '” EULA">' + current.eula.txt + '</a>' + (current.eula.source ? '<a href="' + current.eula.source + '" title="“' + current.name + '” EULA information"><img src="docs/img/vector/source.svg" height="24" alt="(source)" title="“' + current.name + '” EULA information"></a>' : '') : '')
	...
	if(files.length > 0) {
		...
		files.forEach(function(file) {
			...
			// License
			readme += '\r\n<td><a href="docs/legal/' + packageData.license + '.txt" title="“' + packageData._location.substr(1) + '” license">' + packageData.license + '</a><a href="' + packageData.repository.url + '" title="“' + packageData._location.substr(1) + '” license information"><img src="docs/img/vector/source.svg" height="24" alt="(source)" title="“' + packageData._location.substr(1) + '” license information"></a></td>';
