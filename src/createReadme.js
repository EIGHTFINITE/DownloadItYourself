...
function multiplePermissionSources(sources, current) {
	if(is.string(sources))
		return '<a href="' + sources + '" title="“' + current.name + '” permissions quote"><img src="docs/img/clipart/source.svg" height="24" alt="(source)" title="“' + current.name + '” permissions quote"></a>';
	var permissionString = '';
	for (var i = 0; i < sources.length; i++) {
		permissionString += '<a href="' + sources[i] + '" title="“' + current.name + '” permissions quote"><img src="docs/img/clipart/source.svg" height="24" alt="(source)" title="“' + current.name + '” permissions quote"></a>';
	}
...
module.exports = function(filetype) {
	...
	for (var i = 0; i < 3; i++) {
		...
		for (var k = 0; k < global.downloads.length; k++) {
			...
			if((i === 0 && (current.type.includes("executable") || current.type === 'binary' )) || (i === 1 && current.type !== 'library' && !(current.type.includes("executable") || current.type === 'binary' )) || (i === 2 && current.type === 'library')) {
				...
				// Name
				readme += '\r\n<td><a href="' + (current["description-url-override"] ? current["description-url-override"] : current.url) + '" title="' + current.name + '">' + current.name + '</a>' + (current["description-url-override"] && current.url ? ' <a href="' + current.url + '" title="“' + current.name + '” download"><img src="docs/img/clipart/download.svg" height="24" alt="(download)" title="“' + current.name + '” download"></a>' : '') + '</td>';
				...
				// License
				readme += '\r\n<td>' + (current.license ? '<a href="docs/legal/' + current.license.txt + '.txt" title="“' + current.name + '” ' + licenseDedicationTitle(current.license.txt) + '">' + current.license.txt + '</a>' + (current.license.source ? '<a href="' + current.license.source + '" title="“' + current.name + '” license information"><img src="docs/img/clipart/source.svg" height="24" alt="(source)" title="“' + current.name + '” license information"></a>' : '') : '');

				// EULA
				readme += '\r\n' + (current.eula ? ', <a href="docs/legal/' + current.eula.txt + '.txt" title="“' + current.name + '” EULA">' + current.eula.txt + '</a>' + (current.eula.source ? '<a href="' + current.eula.source + '" title="“' + current.name + '” EULA information"><img src="docs/img/clipart/source.svg" height="24" alt="(source)" title="“' + current.name + '” EULA information"></a>' : '') : '')
				...
				// Distribution
				if(filetype === "html")
					readme += '\r\n<td align="center">' + (current.distribution === "allowed" ? '<img src="docs/img/clipart/check.svg" height="24" alt="OK" title="Distribution Allowed">' : '<img src="docs/img/clipart/cross.svg" height="24" alt="No" title="No Distribution Allowed">') + '</td>';
				else
					readme += '\r\n<td align="center">' + (current.distribution === "allowed" ? '<a href="##" title="Distribution Allowed"><img src="docs/img/clipart/check.svg" height="24" alt="OK" title="Distribution Allowed"></a>' : '<a href="##" title="No Distribution Allowed"><img src="docs/img/clipart/cross.svg" height="24" alt="No" title="No Distribution Allowed"></a>') + '</td>';
	...
	if(files.length > 0) {
		...
		files.forEach(function(file) {
			...
			// Icon
			readme += '\r\n<td align="center"><a href="' + packageData.homepage + '" title="' + packageData._location.substr(1) + '"><img src="docs/img/icon/';
			...
			// Name
			readme += '\r\n<td><a href="' + packageData.homepage + '" title="' + packageData._location.substr(1) + '">' + packageData._location.substr(1) + '</a></td>';
			...
			// Distribution
			if(filetype === "html")
				readme += '\r\n<td align="center"><img src="docs/img/clipart/check.svg" height="24" alt="OK" title="Distribution Allowed"></td>';
			else
