...
module.exports = function(filetype) {
	...
	if(files.length > 0) {
		...
		files.forEach(function(file) {
			...
			else if(packageData.repository.url === 'https://github.com/form-data/form-data') {
				packageData.author.url = 'https://github.com/felixge';
			}
			...
			else if(packageData.repository.url === 'https://github.com/bestiejs/punycode.js') {
				packageData.author.url = 'https://github.com/mathiasbynens';
			}
