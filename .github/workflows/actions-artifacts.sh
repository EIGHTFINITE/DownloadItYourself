...
p7zip_short=$(cat downloadlist.json | python -c "import sys, json; print(json.load(sys.stdin)['config']['p7zip-short'])")
...
portable_git_short=$(cat downloadlist.json | python -c "import sys, json; print(json.load(sys.stdin)['config']['portable-git-short'])")
